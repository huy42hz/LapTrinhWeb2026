...
namespace SV22T1020158.DataLayers.Interfaces
{
    ...
    public interface IProductRepository
    {
        ...
        /// <returns></returns>
        Task<ProductPhoto?> GetPhotosAsync(long photoID);
        /// <summary>
        /// Bổ sung ảnh
        /// </summary>
        /// <param name="data"></param>
        ...
        /// <summary>
        /// Tìm kiếm và lấy danh sách mặt hàng cho Shop (chỉ lấy hàng đang bán)
        /// </summary>
        Task<PagedResult<Product>> ListForShopAsync(ProductSearchInput input);
    }
}

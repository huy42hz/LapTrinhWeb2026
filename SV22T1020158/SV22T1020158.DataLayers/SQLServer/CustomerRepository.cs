...
namespace SV22T1020158.DataLayers.SQLServer
    {
        public class CustomerRepository : BaseRepository, ICustomerRepository
        {
            ...
            // Thêm phương thức AddAsync với password
            public async Task<int> AddAsync(Customer data)
            {
                using var connection = GetConnection();

                // Tạo password mặc định nếu chưa có 
            ...
            // Thêm phương thức để lấy customer theo email

...
using SV22T1020158.Shop.Models;
...
namespace SV22T1020213.Shop.Controllers
{
    public class ProductController : Controller
    {
        ...
        [HttpGet]
        // 1. Chuyển thành async Task để đợi (await) dữ liệu từ database
        public async Task<IActionResult> Index(int categoryId = 0, string searchValue = "")
        {
            ...
            // 2. Lấy danh sách Categories (Giống hệt code cũ bạn đưa)
            ...
            // 3. Khởi tạo Model và nạp dữ liệu
